...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        City nigeriaCity1 = City.builder().name("Lagos").population(10733263).country(nigeria).build();
        City nigeriaCity2 = City.builder().name("Abuja").population(1235880).country(nigeria).build();
