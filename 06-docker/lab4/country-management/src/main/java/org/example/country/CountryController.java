...
public class CountryController {
    ...
    public CountryReadDTO createCountry(@RequestBody CountryCreateUpdateDTO dto) {
        ...
        restTemplate.postForObject("http://city-management:8080/api/cities/country/{id}", country.getName(), Void.class, country.getId());
        return new CountryReadDTO(country.getId(), country.getName(), country.getPopulation());
    }
    ...
    public CountryReadDTO updateCountry(@PathVariable UUID id, @RequestBody CountryCreateUpdateDTO dto) {
        ...
        restTemplate.put("http://city-management:8080/api/cities/country/{id}", updatedCountry.getName(), updatedCountry.getId());
    ...
    public void deleteCountry(@PathVariable UUID id) {
        ...
        restTemplate.delete("http://city-management:8080/api/cities/country/{id}", id);
    }
}
